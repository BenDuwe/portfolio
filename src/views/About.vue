<template>
  <div class="about">
    ...
    <div class="person">
      ...
      <p
        class="description"
      >I'm a studious person, who's eager to learn more about the ins and outs of the world around us. My interest in nature and science has led me to obtain a master's degree in biology. Now my passion for thechnology has made me start learning web development and I've been enjoying every part of it.</p>
    </div>
    <div class="hard">
      <h4>Skills:</h4>
      <ul class="btm-spc">
